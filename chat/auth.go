...
//MustAuth easily allows us to add authentication to any object that satisfies the http.Handler interface
...
func loginHandler(w http.ResponseWriter, r *http.Request) {
	...
	if len(segs) < 4 {
		http.Error(w, errors.New("Invalid URL path").Error(), http.StatusBadRequest)
		return
	}
